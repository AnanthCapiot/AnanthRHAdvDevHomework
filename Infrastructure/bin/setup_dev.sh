...
oc set probe dc/mongodb --readiness --failure-threshold 3 --initial-delay-seconds 60 -- "mongo 127.0.0.1:27017/$MONGODB_DATABASE -u $MONGODB_USER -p $MONGODB_PASSWORD --eval='quit()'" && \
